...
::-webkit-scrollbar-thumb { background: #B8926A; border-radius: 2px; }
...
.gold-gradient {
  background: linear-gradient(135deg, #B8926A 0%, #D4B896 50%, #B8926A 100%);
}
...
input:focus, select:focus, textarea:focus {
  outline: none;
  border-color: #B8926A;
  box-shadow: 0 0 0 2px rgba(184, 146, 106, 0.15);
}
